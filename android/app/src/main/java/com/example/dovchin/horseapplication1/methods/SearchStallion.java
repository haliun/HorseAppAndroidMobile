...
public class SearchStallion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SearchStallion.this, AddStallionActivity.class);
        ...
        RecyclerView recyclerview=(RecyclerView)findViewById(R.id.search_stallion_recview);
        LinearLayoutManager llm=new LinearLayoutManager(this);
        recyclerview.setHasFixedSize(true);
        recyclerview.setLayoutManager(llm);
        mAdapter=new DataAdapterStallions(mArrayList);
    ...
    protected void onResume(){
        ...
        if(mFirebaseUser==null){
            Intent intent = new Intent(SearchStallion.this, LoginActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(intent);
        }else{
            mUserId=mFirebaseUser.getUid();
            mDatabase.child("users").child(mUserId).child("Stallions").addListenerForSingleValueEvent(
                    new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            for (DataSnapshot data : dataSnapshot.getChildren()) {
                                Stallion stallions = data.getValue(Stallion.class);
