...
import com.example.dovchin.horseapplication1.Activities.MoneyActivity;
...
public class AddMoneyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnDatePicker = (Button) findViewById(R.id.button_m_date);
        final EditText txtDate = (EditText) findViewById(R.id.editText_m_date);
        //get current date
        ...
        btnDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dd = new DatePickerDialog(AddMoneyActivity.this,
        ...
        final String food_type=extras.getString("type_money");
        String type_array[]={food_type};
        //spinner of listing type
        Spinner types = (Spinner) findViewById(R.id.spinner_money);
        ...
        if (getIntent().getExtras() != null) {
            ...
            if (foodVit != null) {
                Spinner type = (Spinner) findViewById(R.id.spinner_money);
                EditText nameEdtText = (EditText) findViewById(R.id.editText_mey_name);
                EditText txtEdtDate = (EditText) findViewById(R.id.editText_m_date);
                EditText sum = (EditText) findViewById(R.id.editText_m_sum);
                EditText desc=(EditText)findViewById(R.id.editText_m_desc) ;
                nameEdtText.setText(foodVit.getName());
                final String type_txt = foodVit.getType();
                String food="Орлого";
                if(type_txt==food){
                    final String type_array1[]={type_txt,"Орлого"};
                    ...
                    final String type_array1[]={type_txt,"Зарлага"};
                    Adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item,type_array1);
                    Adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    type.setPrompt("Төрлийг сонгоно уу!");
                    //Adapter.add(type_txt);
                ...
                FloatingActionButton fab2 = (FloatingActionButton) findViewById(R.id.floatingActionButton9);
    ...
    public void saveFood(){
        ...
        if(mFirebaseUser==null){
            ...
            if(TextUtils.isEmpty(name)){
                ...
                mDatabase.child("users").child(mUserId).child("Money").updateChildren(childupdates,new DatabaseReference.CompletionListener() {
                    @Override
                ...
                Intent intent = new Intent(AddMoneyActivity.this, MoneyActivity.class);
                startActivity(intent);
    ...
    public void updateFood(String key_id){
        ...
        if(mFirebaseUser==null){
            ...
            if(TextUtils.isEmpty(name)){
                ...
                Query applesQuery = mDatabase.child("users").child(mUserId).child("Money").orderByChild("id").equalTo(key_id);
