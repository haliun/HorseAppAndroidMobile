 ...
 */
public class Colt_fragment  extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.colt_layout);
        Button btnAdd=(Button)findViewById(R.id.buttonADdColt);
        btnAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Colt_fragment.this, AddColtActivity.class);
                startActivity(intent);
            }
        });
        Button btnView=(Button)findViewById(R.id.buttonViewAllColt);
        btnView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Colt_fragment.this, SearchColt.class);
                startActivity(intent);
            }
        });
