 ...
 */
public class ImageAdapterUser extends ArrayAdapter<DisplayData> {
    Context context;
    int layoutResourceId;
    ArrayList<DisplayData> data=new ArrayList<DisplayData>();
    public ImageAdapterUser(Context context, int layoutResourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(row == null)
        {
            ...
            holder.txtTitle = (TextView)row.findViewById(R.id.textViewmoriname);
            holder.txtDesc = (TextView)row.findViewById(R.id.textViewAzarga2);
