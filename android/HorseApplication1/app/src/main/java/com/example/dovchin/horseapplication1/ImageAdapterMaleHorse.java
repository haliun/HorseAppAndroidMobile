 ...
 */
public class ImageAdapterMaleHorse extends ArrayAdapter<DisplayData> {
    Context context;
    int layoutResourceId;
    ArrayList<DisplayData> data=new ArrayList<DisplayData>();
    public ImageAdapterMaleHorse(Context context, int layoutResourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(row == null)
        {
            ...
            holder.imgIcon = (ImageView)row.findViewById(R.id.imageView6);
            row.setTag(holder);
        }
        else        {
